...
const full64bits float64 = 18446744073709551616

// Float64 returns the float64 representation of u. Conversion to float64 can lose precision.
func (u Uint128) Float64() float64 {
	return float64(u.Lo) + (float64(u.Hi) * full64bits)
}

// FromFloat64 converts v to a Uint128 value.
func (u *Uint128) FromFloat64(v float64) {
	u.Lo = uint64(v)
	u.Hi = uint64(v / full64bits)
}
...
func (u Uint128) MarshalJSON() ([]byte, error) {
	// like in Go's math/big, the marshalled number isn't quoted
