...
func TestArithmetic(t *testing.T) {
	// TestArithmetic compares Uint128 arithmetic methods to their math/big equivalents, using random values
...
func TestFloat64(t *testing.T) {
	var fl float64 = 42540766411282592856903984951653826562

	n := Uint128{}
	n.FromFloat64(fl)

	if fl != n.Float64() {
		t.Fatal("incorrect float64 value")
	}
}
...
func TestMarshalText(t *testing.T) {
	...
	test2 = testStruct{}
	err = json.Unmarshal([]byte(`{"Foo":"18446744073709551615","Bar":"340282366920938463463374607431768211455"}`), &test2)
	if err != nil {
		t.Fatal(err)
	}
	if !test2.Foo.Equals(test.Foo) || !test2.Bar.Equals(*test.Bar) {
